...
with input_file() as file:
    ...
    players, points = int(match.group(1)), int(match.group(2)) * 100
...
for _ in range(points):
    ...
    if current_value % 23 != 0:
        ...
        removed_marble_value = circle.pop(current_index)
        marble_score = current_value + removed_marble_value
        # print(f'{marble_score} = {current_value} + {removed_marble_value}')

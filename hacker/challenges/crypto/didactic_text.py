...
value_words = remove_punctuation(value).split()
original_words = remove_punctuation(original).split()

result = ''
while value_words:
    word = value_words.pop(0)
    original_word = original_words.pop(0)
